 ...
 * 
 * <p>
 * Source code lifted from org.apache.nutch.util.NodeWalker
 * </p>
 */
public final class NodeWalker {
    ...
    private NodeCollection currentChildren;
     ...
     * 
     * <p>
     * This is useful when you don't want to process deeper into the current
    ...
    public Element nextElement(String localName) {

        Node node;
        while ((node = nextNode()) != null
                && (node.getNodeType() != Node.ELEMENT_NODE || localName.equals(node.getLocalName()) == false)) {
            ;
        }
    ...
    public Element nextElement(String localName, String text) {

        Node node;
        while ((node = nextNode()) != null && (node.getNodeType() != Node.ELEMENT_NODE
                || localName.equals(node.getLocalName()) == false || text.equals(node.getTextContent()) == false)) {
            ;
        }
