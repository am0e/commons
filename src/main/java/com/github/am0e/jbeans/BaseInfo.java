...
public interface BaseInfo {
    ...
    /**
     * For fields this is the type of the field. For Methods that take a single
     * parameter, this will contain the type of the parameter.
     */
    ...
    MethodHandle getHandle(Lookup lookup, boolean setter);
