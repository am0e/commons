...
/**
 * This is a direct copy of the JDK java.io.StringWriter class but modified to
 * write to a StringBuilder rather than the older, slower StringBuffer class.
 * Obviously this class is therefore not thread safe and synchronization should
 * be provided at the application level if required.
 * <p>
